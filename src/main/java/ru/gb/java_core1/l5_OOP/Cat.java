...
private если использован как дефолтный, тоесть модф. доступа вообще не указан, то он с расширением внутри всего пакета (+ доступ в своем пакете(package))
protected - вызов только из классов наследников, даже из других пакетов (inherited)
